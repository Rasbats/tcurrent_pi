...
#ifndef __tcurrentUIDIALOGBASE_H__
#define __tcurrentUIDIALOGBASE_H__
...
///////////////////////////////////////////////////////////////////////////////
/// Class tcurrentUIDialogBase
///////////////////////////////////////////////////////////////////////////////
class tcurrentUIDialogBase : public wxDialog 
{
	private:
	...
	protected:
		...
		virtual void OnSocketEvent(wxSocketEvent& event) { event.Skip(); }
	...
	public:
		...
		tcurrentUIDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Tidal Current Control"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxDIALOG_NO_PARENT|wxRESIZE_BORDER|wxSYSTEM_MENU ); 
		~tcurrentUIDialogBase();
	
};

///////////////////////////////////////////////////////////////////////////////
/// Class tcurrentSettingsDialogBase
///////////////////////////////////////////////////////////////////////////////
class tcurrentSettingsDialogBase : public wxDialog 
{
	private:
	...
	public:
		...
		tcurrentSettingsDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("tcurrent Settings"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxDEFAULT_DIALOG_STYLE ); 
		~tcurrentSettingsDialogBase();
	
};

///////////////////////////////////////////////////////////////////////////////
/// Class tcurrentPreferencesDialogBase
///////////////////////////////////////////////////////////////////////////////
class tcurrentPreferencesDialogBase : public wxDialog 
{
	private:
	...
	public:
		...
		tcurrentPreferencesDialogBase( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Preferences"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE ); 
		~tcurrentPreferencesDialogBase();
	
};


#endif //__tcurrentUIDIALOGBASE_H__
