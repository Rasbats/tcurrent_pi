...
tcurrentUIDialogBase::tcurrentUIDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	this->Connect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( tcurrentUIDialogBase::OnClose ) );
	this->Connect( wxEVT_SIZE, wxSizeEventHandler( tcurrentUIDialogBase::OnSize ) );
    this->Connect( wxEVT_SOCKET, wxSocketEventHandler( tcurrentUIDialogBase::OnSocketEvent) );

    m_choice1->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( tcurrentUIDialogBase::OnPortChanged), NULL, this );
    m_datePicker1->Connect( wxEVT_DATE_CHANGED, wxDateEventHandler( tcurrentUIDialogBase::OnDateSelChanged ), NULL, this );

	m_bpNow->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::OnNow ), NULL, this );

	m_bpPrev->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::OnPrev ), NULL, this );
	m_bpNext->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::OnNext ), NULL, this );
	m_button33->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::About ), NULL, this );

}

tcurrentUIDialogBase::~tcurrentUIDialogBase()
{
	// Disconnect Events
	this->Disconnect( wxEVT_CLOSE_WINDOW, wxCloseEventHandler( tcurrentUIDialogBase::OnClose ) );
	this->Disconnect( wxEVT_SIZE, wxSizeEventHandler( tcurrentUIDialogBase::OnSize ) );
 	this->Disconnect( wxEVT_SOCKET, wxSocketEventHandler( tcurrentUIDialogBase::OnSocketEvent) );

    m_choice1->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( tcurrentUIDialogBase::OnPortChanged), NULL, this );
    m_datePicker1->Disconnect( wxEVT_DATE_CHANGED, wxDateEventHandler( tcurrentUIDialogBase::OnDateSelChanged ), NULL, this );

	m_bpNow->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::OnNow ), NULL, this );

	m_bpPrev->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::OnPrev ), NULL, this );
	m_bpNext->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::OnNext ), NULL, this );
	m_button33->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( tcurrentUIDialogBase::About ), NULL, this );
	
}

tcurrentPreferencesDialogBase::tcurrentPreferencesDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
...
tcurrentPreferencesDialogBase::~tcurrentPreferencesDialogBase()
{
